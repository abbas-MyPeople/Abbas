...
(() => {
  ...
  const TOOLS = [
    ...
    { n:'Presto (Phoenix)', c:'AI drive-thru', u:'https://presto.com', p:'est. ~$1,000+/mo/lane', w:'Drive-thru voice AI live across hundreds of lanes.', t:['qsr'], pr:['slow-service','labor'], g:['time'], s:['multi'], b:['serious'], fit:'Proven drive-thru automation at scale.', not:'Vendor recovering from past financial distress.' },
    ...
    { n:'Fivestars (SumUp)', c:'Loyalty & CRM', u:'https://fivestars.com', p:'est. ~$ custom (annual)', w:'Turnkey SMB loyalty with phone-number enrollment and auto-marketing.', t:['qsr','fast-casual'], pr:['retention'], g:['guests'], s:['single','small'], b:['modest','serious'], fit:'Plug-and-play loyalty for small operators.', not:'Opaque pricing; lacks enterprise CDP depth.' },
    ...
    { n:'Cuboh (by ChowNow)', c:'Delivery & aggregators', u:'https://cuboh.com', p:'est. ~$100–300/mo/loc', w:'Consolidates delivery apps into one device with POS sync.', t:['qsr','fast-casual','ghost'], pr:['delivery-cost','connect'], g:['connect','time'], s:['single','small'], b:['modest','serious'], fit:'Simple tablet consolidation for delivery orders.', not:'Roadmap skews to the ChowNow ecosystem.' },
    { n:'Nextbite', c:'Delivery & aggregators', u:'https://nextbite.io', p:'est. ~$ quote (dashboard free)', w:'Virtual restaurant brands plus an order-management dashboard.', t:['ghost','qsr'], pr:['delivery-cost','margins'], g:['guests'], s:['single','small'], b:['modest','serious'], fit:'Spin up delivery-only brands from your kitchen.', not:'Virtual-brand revenue is volatile and unguaranteed.' },
