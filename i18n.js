...
(function () {
  ...
  const ROWS = [
    ...
    // --- refreshed: PROBLEM band ---
    [`The real problem isn't just the apps.`, `असली समस्या सिर्फ़ ऐप्स नहीं हैं।`, `اصل مسئلہ صرف ایپس نہیں ہیں۔`],
    [`Big chains have whole teams for technology and strategy. You've got a kitchen to run — so money leaks where you don't have the time or the know-how to look:`, `बड़ी चेन के पास टेक्नोलॉजी और रणनीति के लिए पूरी टीमें होती हैं। आपके पास तो एक किचन चलाना है — इसलिए पैसा वहाँ रिसता है जहाँ देखने का न आपके पास समय है, न जानकारी:`, `بڑی چینز کے پاس ٹیکنالوجی اور حکمتِ عملی کے لیے پوری ٹیمیں ہوتی ہیں۔ آپ کے پاس تو ایک کچن چلانا ہے — اس لیے پیسہ وہاں رِستا ہے جہاں دیکھنے کا نہ آپ کے پاس وقت ہے، نہ معلومات:`],
    [`The apps keep <strong>15–30%</strong> of every order — and walk off with <strong>your customer</strong>.`, `ऐप्स हर ऑर्डर का <strong>15–30%</strong> रख लेते हैं — और <strong>आपका ग्राहक</strong> भी ले जाते हैं।`, `ایپس ہر آرڈر کا <strong>15–30%</strong> رکھ لیتے ہیں — اور <strong>آپ کا گاہک</strong> بھی لے جاتے ہیں۔`],
    [`The phone rings through the rush with <strong>no one free to answer it</strong>.`, `भीड़ के समय फ़ोन बजता रहता है पर <strong>उठाने वाला कोई फ़्री नहीं</strong>।`, `رش کے وقت فون بجتا رہتا ہے مگر <strong>اٹھانے والا کوئی فارغ نہیں</strong>۔`],
    [`A dozen tools that <strong>don't talk to each other</strong> — and no time to fix it.`, `दर्जनों टूल जो <strong>आपस में बात नहीं करते</strong> — और ठीक करने का समय नहीं।`, `درجنوں ٹولز جو <strong>آپس میں بات نہیں کرتے</strong> — اور ٹھیک کرنے کا وقت نہیں۔`],
    [`No clear view of your numbers, and <strong>no strategy</strong> the way the big chains have one.`, `अपने आँकड़ों की कोई साफ़ तस्वीर नहीं, और <strong>कोई रणनीति नहीं</strong> जैसी बड़ी चेन के पास होती है।`, `اپنے اعداد کی کوئی صاف تصویر نہیں، اور <strong>کوئی حکمتِ عملی نہیں</strong> جیسی بڑی چینز کے پاس ہوتی ہے۔`],
    [`<em>None of it is permanent — and you shouldn't have to become a tech expert to fix it.</em> That's our job: we bring the know-how, the industry strategy, and the team big chains pay for — and from the <strong>100+ tools out there</strong>, only the few that actually fit you. You keep control, your data, and the upside.`, `<em>यह सब हमेशा के लिए नहीं है — और इसे ठीक करने के लिए आपको टेक एक्सपर्ट बनने की ज़रूरत नहीं।</em> यह हमारा काम है: हम वह जानकारी, इंडस्ट्री की रणनीति और टीम लाते हैं जिसके लिए बड़ी चेन पैसे देती हैं — और <strong>बाहर मौजूद 100+ टूल्स में से</strong> सिर्फ़ वही चंद जो आप पर सही बैठें। नियंत्रण, आपका डेटा और फ़ायदा — सब आपके पास रहता है।`, `<em>یہ سب ہمیشہ کے لیے نہیں ہے — اور اسے ٹھیک کرنے کے لیے آپ کو ٹیک ماہر بننے کی ضرورت نہیں۔</em> یہ ہمارا کام ہے: ہم وہ معلومات، انڈسٹری کی حکمتِ عملی اور ٹیم لاتے ہیں جس کے لیے بڑی چینز پیسے دیتی ہیں — اور <strong>باہر موجود 100+ ٹولز میں سے</strong> صرف وہی چند جو آپ پر صحیح بیٹھیں۔ کنٹرول، آپ کا ڈیٹا اور فائدہ — سب آپ کے پاس رہتا ہے۔`],

    // --- refreshed: HOW IT WORKS ---
    ...
    [`<strong>What we do:</strong> we're a restaurant family — and the tech team you could never afford to hire. We find every leak and fix it, setting up only the few of 100+ tools that actually fit you. You keep your customers, your data, and the upside.`, `<strong>हम क्या करते हैं:</strong> हम एक रेस्तराँ परिवार हैं — और वह टेक टीम जिसे आप कभी रख नहीं सकते। हम हर रिसाव खोजकर ठीक करते हैं, और 100+ टूल्स में से सिर्फ़ वही चंद लगाते हैं जो आप पर सही बैठें। आपके ग्राहक, आपका डेटा और फ़ायदा — सब आपके पास।`, `<strong>ہم کیا کرتے ہیں:</strong> ہم ایک ریستوران خاندان ہیں — اور وہ ٹیک ٹیم جسے آپ کبھی رکھ نہیں سکتے۔ ہم ہر رساؤ ڈھونڈ کر ٹھیک کرتے ہیں، اور 100+ ٹولز میں سے صرف وہی چند لگاتے ہیں جو آپ پر صحیح بیٹھیں۔ آپ کے گاہک، آپ کا ڈیٹا اور فائدہ — سب آپ کے پاس۔`],
  ...
  const SEL = [
    ...
    '.stat span',
    '.ctaband p', '.ctaband a',
    '#how .kicker', '#how .h2', '#how .section__head .lead', '.lifecycle li h3', '.lifecycle li p', '.steps summary', '.steps details > p', '.promise',
