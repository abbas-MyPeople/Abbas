...
(function () {
  ...
  const ROWS = [
    ...
    [`The delivery apps, the creeping fees, the dozen tools that don't talk to each other — they've quietly turned you into a supplier in someone else's store. We're a restaurant family with a serious tech team, and we help you take it back: own your guests, keep your margin, and run your restaurant like it's yours again.`, `डिलीवरी ऐप्स, बढ़ती फ़ीस, और दर्जनों ऐसे टूल जो आपस में बात तक नहीं करते — इन्होंने चुपचाप आपको किसी और की दुकान का सप्लायर बना दिया है। हम एक रेस्तराँ परिवार हैं जिसके पास एक मज़बूत टेक टीम है, और हम आपको यह वापस दिलाते हैं: अपने ग्राहक खुद के रखें, अपना मुनाफ़ा बचाएँ, और अपने रेस्तराँ को फिर से अपना बनाकर चलाएँ।`, `ڈیلیوری ایپس، بڑھتی فیس، اور درجنوں ایسے ٹولز جو آپس میں بات تک نہیں کرتے — اِنہوں نے خاموشی سے آپ کو کسی اور کی دکان کا سپلائر بنا دیا ہے۔ ہم ایک ریستوران خاندان ہیں جس کے پاس ایک مضبوط ٹیک ٹیم ہے، اور ہم آپ کو یہ واپس دلاتے ہیں: اپنے گاہک خود رکھیں، اپنا منافع بچائیں، اور اپنے ریستوران کو دوبارہ اپنا بنا کر چلائیں۔`],
    ...
    [`One small spot`, `एक छोटी जगह`, `ایک چھوٹی جگہ`],
    [`A family restaurant`, `एक फ़ैमिली रेस्तराँ`, `ایک فیملی ریستوران`],
